...
| M4 반복 플레이 | [WP-004](../backlog/WP-004.md) | READY | 시작·정지·확인·결과·재도전, 입력 차단과 설정 유지 |

**다음 작업: WP-004 READY (2026-09-16)** — 일시정지·재시작 확인 → 결과 화면 → 시작 화면·설정. 구현 후 AC-01~08과 실제 화면·기존 회귀를 검증한다.
